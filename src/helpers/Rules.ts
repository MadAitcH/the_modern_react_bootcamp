// TODO: this file might be broken, I'm not sure.
type Dice = number[];
...
export class Rule {
  ...
  countVal(dice: Dice, val: number): number {
...
class TotalOneNumber extends Rule {
  evalRoll = (dice: Dice) => {
    return this.val * this.countVal(dice, this.val);
  };
}
